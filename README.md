...
챗봇 상담 → 화상상담 요청 → **약사 승인** → QR 로그인 → 수령까지의 흐름을 최소 기능으로 구현했습니다. AI는 이 흐름 어디에서도 최종 승인 권한이 없고, 승인은 항상 약사가 명시적으로 수행합니다. 자세한 설계 배경과 아직 스텁인 부분(인증, 화상상담, 자판기 하드웨어)은 [`CLAUDE.md`](./CLAUDE.md)의 "9. 약사 상담 + 자판기 QR 연동"을 참고하세요.
